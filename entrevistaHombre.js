...
function pintaPregunta(maindivUser, maindivBot) {
    ...
    userDiv.id = "user";
    userDiv.innerHTML = preguntasHombre[preguntaAleatoria][0];
    maindivUser.appendChild(userDiv);

    // Escribimos pregunta en chat del bot
    let botDiv = document.createElement("div");
    botDiv.id = "bot";
    botDiv.innerHTML = preguntasMujer[preguntaAleatoria][0];
...
function creaBotones(maindivUser, maindivBot) {
    ...
    botDivAnswer.innerHTML = preguntasMujer[preguntaAleatoria][1];
